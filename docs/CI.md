...
| --- | --- | --- | --- | --- |
| Fast | `make ci-fast` | Ruff 0.15.20 formatting and lint (including public return annotations), typed record-boundary checks, and core catalog/config/theme unit tests | None beyond `make install` | ~30 seconds |
