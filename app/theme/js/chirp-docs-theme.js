...
(function () {
  ...
  window.ChirpDocsTheme = {
    enhance: enhance,
    setTheme: setTheme,
    getTheme: getStoredTheme,
  };

  if (window.ChirpDocs && window.ChirpDocs.enhance && window.ChirpDocs.enhance.register) {
    window.ChirpDocs.enhance.register('theme-menu', { enhance: enhance });
