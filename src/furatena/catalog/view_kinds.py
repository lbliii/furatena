...
_SHELL_OPTIONAL = frozenset(
    {
        ...
        "pr_preview",
        "pr_preview.head_sha",
        "pr_preview.pull_request_number",
        "pr_preview.review_url",
        "pr_preview.short_sha",
        "route_link_attrs",
        "rendering_head",
        "rendering_head.id",
        "resolved_theme",
        "resolved_theme.theme_id",
        "resolved_theme.theme_use",
        "shell_outlet_attrs",
...
VIEW_KINDS: tuple[ViewKindSpec, ...] = (
    ...
    ViewKindSpec(
        ...
        "catalog",
        False,
        "API reference page — OpenAPI operation index/detail layout with request, response, auth, and related-doc affordances.",
        required_context=_CATALOG_CONTEXT,
        optional_context=_CATALOG_OPTIONAL
        | frozenset(
            {
                "node.meta.api_operation",
                "node.meta.api_operation.operation_id",
                "node.meta.api_operation.method",
                "node.meta.api_operation.path",
                "node.meta.api_operation.summary",
                "node.meta.api_operation.tags",
                "node.meta.api_operation.schemas",
                "node.meta.api_operation.request_bodies",
                "node.meta.api_operation.responses",
                "node.meta.api_operation.examples",
                "node.meta.api_operation.auth",
                "node.meta.api_operation.environments",
                "node.meta.api_operation.external_docs",
                "node.meta.api_try_it",
                "node.meta.element_type",
                "operation",
                ...
                "try_it.base_urls",
                "try_it.auth",
                "try_it.static_export.fallback_mode",
                "try_it.static_export.reason",
                "mode.id",
                "mode.available",
                "mode.disabled_reason",
                "mode.request_behavior",
                "base.label",
                "base.url",
                "base.base_url_env",
                "auth.scheme",
