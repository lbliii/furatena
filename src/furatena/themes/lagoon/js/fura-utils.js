...
(function () {
  ...
  // Debug mode flag (set via window.FuraDocs.debug = true)
  const DEBUG = (window.FuraDocs && window.FuraDocs.debug) || false;
  ...
  const safeStorage = {
    ...
    get(key) {
      try {
        ...
        console.warn('[FuraDocs] localStorage.getItem blocked:', err);
        return null;
      }
    },
    ...
    set(key, value) {
      try {
        ...
        console.warn('[FuraDocs] localStorage.setItem blocked:', err);
        return false;
      }
    },
    ...
    remove(key) {
      try {
        ...
        console.warn('[FuraDocs] localStorage.removeItem blocked:', err);
        return false;
      }
    }
  };
