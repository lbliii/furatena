...
| Routes | `route` | 46 routes; 36 linked, 10 missing |
| Configuration | `config_field` | 236 fields; all identifier-linked |
| MCP | `mcp_tool`, `mcp_resource` | 16 tools and 10 stable resources; 24 linked, 2 missing |
| Sidecars | `sidecar` | 25 machine-readable/live outputs; all identifier-linked |
| Diagnostics | `diagnostic` | 46 rule ids/families; 6 linked, 40 missing |
