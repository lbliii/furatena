...
|---|---|---|---|
| `CHIRP_ENV` | read | None | `furatena/catalog/docs_app.py:282` |
| `CHIRP_SECRET_KEY` | read | None | `furatena/catalog/docs_app.py:288` |
| `CHIRP_SKIP_CONTRACT_CHECKS` | read, write | '', None | `furatena/catalog/docs_app.py:507`, `furatena/cli/commands/serve.py:115`, `furatena/cli/commands/serve.py:122`, `furatena/cli/commands/serve.py:135` |
...
| `FURA_AUTODOC` | read, write | '1', None | `furatena/catalog/docs_app.py:2079`, `furatena/cli/commands/serve.py:47` |
...
| `FURA_CONTENT_RESTART_AFTER_PROMOTION` | read | '1' | `furatena/catalog/route_registrars.py:139` |
| `FURA_CONTENT_STATE_ROOT` | read | '/data/furatena' | `furatena/catalog/build_identity.py:18`, `furatena/cli/commands/content.py:124` |
| `FURA_DISTRIBUTION` | read | '', 'source' | `furatena/catalog/build_identity.py:71`, `furatena/catalog/docs_app.py:317` |
| `FURA_ENV` | read | None | `furatena/catalog/docs_app.py:282` |
...
| `FURA_IMAGE_DIGEST` | read | '', 'unknown' | `furatena/catalog/build_identity.py:75`, `furatena/catalog/content_deployment.py:311`, `furatena/catalog/content_deployment.py:564`, `furatena/catalog/content_deployment.py:676`, `furatena/catalog/content_refresh.py:513`, `furatena/catalog/operational_status.py:168` |
| `FURA_IMAGE_VERSION` | read | 'development' | `furatena/catalog/build_identity.py:76` |
| `FURA_KEEP_ALIVE_TIMEOUT` | read | '5' | `furatena/catalog/docs_app.py:298` |
...
| `FURA_SERVER_WORKERS` | read | '' | `furatena/catalog/docs_app.py:315` |
| `FURA_SESSION_SECRET` | read | None | `furatena/catalog/docs_app.py:288` |
