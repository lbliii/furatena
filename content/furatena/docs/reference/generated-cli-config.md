...
|---|---|---|---|
| `CHIRP_ENV` | read | None | `furatena/catalog/docs_app.py:235` |
| `CHIRP_SECRET_KEY` | read | None | `furatena/catalog/docs_app.py:241` |
| `CHIRP_SKIP_CONTRACT_CHECKS` | read | '' | `furatena/catalog/docs_app.py:385` |
| `FURA_APP_ROOT` | read | None | `furatena/cli/commands/_shared.py:41` |
| `FURA_AUTODOC` | read, write | '1', None | `furatena/catalog/docs_app.py:1509`, `furatena/cli/commands/serve.py:41` |
...
| `FURA_BASE_URL` | read, write | '', None | `furatena/catalog/seo.py:18`, `furatena/catalog/static_export.py:192`, `furatena/catalog/static_export.py:314`, `furatena/catalog/static_export.py:319`, `furatena/cli/commands/export.py:26`, `furatena/cli/commands/pdf.py:26`, `furatena/cli/commands/serve.py:45` |
...
| `FURA_ENV` | read | None | `furatena/catalog/docs_app.py:235` |
| `FURA_FROZEN` | read | None | `furatena/cli/commands/serve.py:75` |
| `FURA_HTMX_PREVIEW` | read | '' | `furatena/catalog/vendor_paths.py:33` |
| `FURA_KEEP_ALIVE_TIMEOUT` | read | '5' | `furatena/catalog/docs_app.py:251` |
...
| `FURA_SESSION_SECRET` | read | None | `furatena/catalog/docs_app.py:241` |
