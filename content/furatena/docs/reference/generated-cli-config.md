...
|---|---|---|---|
| `CHIRP_ENV` | read | None | `furatena/catalog/docs_app.py:113` |
| `CHIRP_SECRET_KEY` | read | None | `furatena/catalog/docs_app.py:119` |
| `CHIRP_SKIP_CONTRACT_CHECKS` | read | '' | `furatena/catalog/docs_app.py:232` |
| `FURA_APP_ROOT` | read | None | `furatena/cli/commands/_shared.py:41` |
| `FURA_AUTODOC` | read, write | '1', None | `furatena/catalog/docs_app.py:1200`, `furatena/cli/commands/serve.py:41` |
...
| `FURA_ENV` | read | None | `furatena/catalog/docs_app.py:113` |
...
| `FURA_SESSION_SECRET` | read | None | `furatena/catalog/docs_app.py:119` |
