...
| `FURA_AUTODOC` | read, write | '1', None | `furatena/catalog/docs_app.py:1538`, `furatena/cli/commands/serve.py:42` |
...
| `FURA_DISTRIBUTION` | read | 'source' | `furatena/catalog/build_identity.py:49` |
